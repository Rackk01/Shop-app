									...
									<div class="card-header align-items-center py-5 gap-2 gap-md-5">
										...
										<div class="card-title">
											...
											<div class="d-flex align-items-center position-relative my-1">
												...
												<!--end::Svg Icon-->
												<input type="text" data-kt-ecommerce-order-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Buscar Cliente" />
											</div>
											<!--end::Search-->
										</div>
										<!--end::Card title-->
										...
										<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_sales_table">
											...
											<thead>
												...
												<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
													...
													<th class="text-end min-w-100px">Dni/Cuit</th>
													<th class="text-end min-w-100px">Teléfono</th>
													<th class="text-end min-w-100px">Domicilio</th>
													<th class="text-end min-w-100px">Localidad</th>
											...
											<tbody class="fw-semibold text-gray-600">
												<?php
												$dataArrayAllClients = getAllCliWeb();
												$amount = count(json_decode($dataArrayAllClients, true));
												// echo $dataArrayAllClients;
												if ($amount > 0) {
													$contador = 0;
													foreach (json_decode($dataArrayAllClients, true) as $dato) {
														// if($contador >= 10){
														// 	break;
														// }
														// $contador++;
												...
												?>
														<tr>
															...
															<!-- <td class="text-end pe-0" data-order="<?php echo (trim($dato['email'])); ?>">
																<span class="fw-bold">
																	<?php
																	// echo trim($dato['email']);
																	?>
															...
															<!--begin::Total=-->
															<td class="text-end pe-0" data-order="<?php echo (trim($dato['cdni'])); ?>">
																<span class="fw-bold">
																	<?php
																	if (trim($dato['cdni']) != '') {
																		echo $dato['cdni'];
															...
															<!--begin::Date Added=-->
															<td class="text-end" data-order="<?php echo (trim($dato['ctel1'])); ?>">
																<span class="fw-bold">
																	<?php
																	echo trim($dato['ctel1']);
																	?>
																</span>
															</td>
															<!--end::Date Added=-->
															...
															<td class="text-end" data-order="<?php echo trim($dato['domicilio']); ?>">
																<span class="fw-bold"><?php echo trim($dato['domicilio']); ?></span>
															</td>
															<!--end::Date Modified=-->

															<td class="text-end" data-order="<?php echo trim($dato['localidad']); ?>">
																<span class="fw-bold"><?php echo trim($dato['localidad']); ?></span>
															</td>
															...
															<td class="text-end">
																...
																<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
																	...
																	<div class="menu-item px-3">
																		<!-- <a href="client-detail?cod=<?php echo trim($dato['id_cliente']); ?>" class="menu-link px-3">Ver</a> -->
