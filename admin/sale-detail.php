...
$dataArrayPedidoSeleccionado = reemplazarPorAcentos(getOneSaleOfCod($_GET['cod']));
// echo $dataArrayPedidoSeleccionado;
// return;

$dataArrayPedidoSeleccionado = str_replace('[', '', $dataArrayPedidoSeleccionado);
$dataArrayPedidoSeleccionado = str_replace(']', '', $dataArrayPedidoSeleccionado);

$dataArrayIteremProductsPedidoSeleccionado = getAllProductsOfSaleCod($_GET['cod']);
$dataArrayIteremCombosPedidoSeleccionado = getAllCombosOfSaleCod($_GET['cod']);
// echo getOneValueOfJsonData($dataArrayPedidoSeleccionado, 'fecha');
// return;
?>
						...
						<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
							...
							<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
								...
								<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
									<!--begin::Title-->
									<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Detalle de pedido</h1>
									<!--end::Title-->
									<!--begin::Breadcrumb-->
								...
								<div class="d-flex align-items-center gap-2 gap-lg-3">
									...
									<!-- <div class="m-0">
										...
										<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_62cfa7b6e82ff">
											<div class="px-7 py-5">
											...
											<div class="px-7 py-5">
												<div class="mb-10">
													...
													<div>
														<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_62cfa7b6e82ff" data-allow-clear="true">
															<option></option>
								...
								<div class="d-flex flex-column gap-7 gap-lg-10">
									<div class="d-flex flex-wrap flex-stack gap-5 gap-lg-10">
										...
										<ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-lg-n2 me-auto">
											<!--begin:::Tab item-->
											<li class="nav-item">
												<a class="nav-link text-active-primary pb-4 active" data-bs-toggle="tab" href="#kt_ecommerce_sales_order_summary">Resumen del pedido</a>
											</li>
											<!--end:::Tab item-->
											<!--begin:::Tab item-->

											<!-- <li class="nav-item">
												<a class="nav-link text-active-primary pb-4" data-bs-toggle="tab" href="#kt_ecommerce_sales_order_history">Historial de pedidos</a>
											</li> -->
										...
										<!--end:::Tabs-->
										<!--begin::Button-->
										<a href="sale-list" class="btn btn-icon btn-light btn-sm ms-auto me-lg-n7">
										...
										<!--end::Button-->
										<!--begin::Button-->
										<a href="sale-edit?cod=<?php echo (getOneValueOfJsonData($dataArrayPedidoSeleccionado, 'nrocomp')); ?>" class="btn btn-success btn-sm me-lg-n7">Editar Pedido</a>
										<!--end::Button-->
										<!--begin::Button-->
											...
											<div class="card-header">
												<div class="card-title">
													<h2>
														Número de pedido (#
														<?php
														echo (getOneValueOfJsonData($dataArrayPedidoSeleccionado, 'nrocomp'));
														?>
														)
													</h2>
												</div>
														...
														<tbody class="fw-semibold text-gray-600">
															...
															<tr>
																...
																<td class="fw-bold text-end">
																	<?php
																	echo changeDateFormat1(getOneValueOfJsonData($dataArrayPedidoSeleccionado, 'fecha'));
																	?>
																</td>
															</tr>
															<!--end::Date-->
															...
															<tr>
																...
																<td class="fw-bold text-end">
																	<?php
																	echo getOneValueOfJsonData($dataArrayPedidoSeleccionado, 'nom_forpag');
																	?>
															...
															<tr>
																...
																<td class="fw-bold text-end">
																	<?php
																	if (str_contains(strtolower(getOneValueOfJsonData($dataArrayPedidoSeleccionado, 'comentario')), 'sucursal')) {
													...
													<table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
														...
														<tbody class="fw-semibold text-gray-600">
																...
																<td class="fw-bold text-end">
																	<div class="d-flex align-items-center justify-content-end">
																		...
																		<a href="" class="text-gray-600 text-hover-primary">
																			<?php
																			echo getOneValueOfJsonData($dataArrayPedidoSeleccionado, 'nombre');
																			?>
																		</a>
																		<!--end::Name-->
																	</div>
															...
															<tr>
																...
																<td class="fw-bold text-end">
																	<a href="../../demo1/dist/apps/user-management/users/view.html" class="text-gray-600 text-hover-primary">
																		<?php
																		echo getOneValueOfJsonData($dataArrayPedidoSeleccionado, 'email');
																		?>
																	</a>
																</td>
															</tr>
															...
															<tr>
																...
																<td class="fw-bold text-end">
																	<?php
																	echo getOneValueOfJsonData($dataArrayPedidoSeleccionado, 'ctel1');
																	?>
																</td>
															</tr>
															<!--end::Date-->
														...
														<tbody class="fw-semibold text-gray-600">
															...
															<tr>
																<td class="text-muted">
																	<div class="d-flex align-items-center">
																		<span class="svg-icon svg-icon-2 me-2">
																			<svg fill="currentColor" height="24" width="24" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512.00 512.00" enable-background="new 0 0 512 512" xml:space="preserve">
																				<g id="SVGRepo_bgCarrier" stroke-width="0"></g>
																				<g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" stroke="#CCCCCC" stroke-width="12.288"></g>
																				<g id="SVGRepo_iconCarrier">
																					<path opacity="0.3" d="M448,0H64C28.6,0,0,28.6,0,64v256c0,35.4,28.6,64,64,64h128l-42.7,128l192-128H448c35.4,0,64-28.6,64-64V64 C512,28.6,483.4,0,448,0z M128,234.7c-23.6,0-42.7-19.1-42.7-42.7s19.1-42.7,42.7-42.7s42.7,19.1,42.7,42.7S151.6,234.7,128,234.7z M256,234.7c-23.6,0-42.7-19.1-42.7-42.7s19.1-42.7,42.7-42.7s42.7,19.1,42.7,42.7S279.6,234.7,256,234.7z M384,234.7 c-23.6,0-42.7-19.1-42.7-42.7s19.1-42.7,42.7-42.7s42.7,19.1,42.7,42.7S407.6,234.7,384,234.7z"></path>
																				</g>
																			</svg>
																		</span>
																		Comentario
																		<i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="" data-bs-original-title="Último comentario agregado por el administrador"></i>
																	</div>
																</td>
																<td class="fw-bold text-end">
																	<?php $orderComments = json_decode(getAllOrderComments($_GET['cod']),true) ?>
																	<span><?php echo $orderComments[0]['comentario'] ?? 'Sin datos'; ?></span>
																</td>
															</tr>
														</tbody>
													</table>
											...
											<div class="d-flex flex-column gap-7 gap-lg-10">
												<div class="d-flex flex-column flex-xl-row gap-7 gap-lg-10">
													...
													<div class="card card-flush py-4 flex-row-fluid overflow-hidden">
														...
														<div class="card-body pt-0">
															<?php
															echo getOneValueOfJsonData($dataArrayPedidoSeleccionado, 'comentario');
															?>
														</div>
														<!--end::Card body-->
													</div>
															...
															<table class="table align-middle table-row-dashed fs-6 gy-5 mb-0">
																...
																<thead>
																	<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
																		...
																		<th class="min-w-100px text-end">Present.</th>
																		<th class="min-w-70px text-end">Cantidad</th>
																		<th class="min-w-100px text-end">P. Unit</th>
																		<th class="min-w-100px text-end">Descuento</th>
																...
																<tbody class="fw-semibold text-gray-600">
																	...
																	if ($dataArrayIteremProductsPedidoSeleccionado != 'null') {
																		...
																		if ($amount > 0) {
																			...
																			foreach (json_decode($dataArrayIteremProductsPedidoSeleccionado, true) as $datoItemProd) {
																				$urlImage = '../src/img/productos/default.jpg';
																					...
																					<tr>
																						...
																						<td>
																							<div class="d-flex align-items-center">
																								...
																								<!--begin::Title-->
																								<div class="ms-5">
																									<a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html" class="fw-bold text-gray-600 text-hover-primary">
																										<?php echo trim($datoItemProd['denom']); ?>
																									</a>
																									<div class="fs-7 text-muted">Código: <?php echo $datoItemProd['cod']; ?></div>
																									<div class="fs-7 text-muted">
																										Tipo:
																										<?php
																										if (strtolower(trim($datoItemProd['tipitem'])) == 'producto') {
																											echo 'Producto';
																										} else if (strtolower(trim($datoItemProd['tipitem'])) == 'combo') {
																											echo 'Combo';
																										} else {
																											echo 'Costo envío';
																										}
																						...
																						<td class="text-end">
																							<?php
																							if (intval(trim($datoItemProd['pesopres'])) != 0 && (trim($datoItemProd['pesopres'])) != null && (trim($datoItemProd['pesopres'])) != '') {
																								echo trim($datoItemProd['pesopres']) . ' KG';
																							} else {
																								echo 'Unid.';
																							}
																							?>
																						...
																						<!--end::SKU-->
																						<!--begin::Quantity-->
																						<td class="text-end"><?php echo strtoupper(trim($datoItemProd['piezas'])); ?></td>
																						<!--end::Quantity-->
																						<!--begin::Price-->
																						<td class="text-end">
																							$
																							<?php echo number_format(trim($datoItemProd['precio']), 2); ?>
																						</td>
																						<!--end::Price-->
																						<!--begin::Total-->
																						<td class="text-end">
																							<?php
																							if (strtolower(trim($datoItemProd['tipboni'])) == 'p' && floatval(trim($datoItemProd['monto_descuento_item'])) > 0) {
																								// Porcentaje
																								echo 'Porcent. - ' . trim($datoItemProd['monto_descuento_item']) . ' %';
																							} else if (strtolower(trim($datoItemProd['tipboni'])) == 'f'  && floatval(trim($datoItemProd['monto_descuento_item'])) > 0) {
																								// Porcentaje
																								echo 'Fijo - $ ' . trim($datoItemProd['monto_descuento_item']);
																							} else {
																								echo '-';
																							}
																							?>
																						...
																						<td class="text-end">
																							$
																							<?php
																							echo number_format(trim($datoItemProd['importe']), 2);
																							$montoTotalDelPedidoSinDescuentoGral += floatval($datoItemProd['importe']);
																							?>
																						</td>
																						<!--end::Total-->
																					</tr>
																	...
																	<!-- SECCIÓN DE ITEREM COMBOS -->
																	<?php
																	if ($dataArrayIteremCombosPedidoSeleccionado != 'null') {
																		$amount = count(json_decode($dataArrayIteremCombosPedidoSeleccionado, true));
																		if ($amount > 0) {
																			$contador = 0;
																			foreach (json_decode($dataArrayIteremCombosPedidoSeleccionado, true) as $datoItemProd) {
																				$urlImage = '../assets/imgs/shop/product-1-1.jpg';
																				if (file_exists('../src/img/combos/' . $datoItemProd['cod'] . '_1.png')) {
																					$urlImage = '../src/img/combos/' . $datoItemProd['cod'] . '_1.png';
																				} else {
																				...
																				<tr>
																					...
																					<td>
																						<div class="d-flex align-items-center">
																							...
																							<!--begin::Title-->
																							<div class="ms-5">
																								<a href="combo-edit?num=<?php echo $datoItemProd['cod']; ?>" class="fw-bold text-gray-600 text-hover-primary">
																									<?php echo trim($datoItemProd['denom_combo']); ?>
																								</a>
																								<div class="fs-7 text-muted">Código: <?php echo $datoItemProd['cod']; ?></div>
																								<div class="fs-7 text-muted">
																									Tipo:
																	...
																	<tr>
																		...
																		<td class="text-end">
																			$
																			<?php
																			echo number_format($montoTotalDelPedidoSinDescuentoGral, 2);
																			?>
																		</td>
																	</tr>
																	<!--end::Subtotal-->
																	...
																	<tr>
																		<td colspan="5" class="text-end">
																			Desc. gral
																			<?php
																			$descuentoGeneralPedido = floatval(
																				getOneValueOfJsonData($dataArrayPedidoSeleccionado, 'porc_desc_gral')
																			);
																			if ($descuentoGeneralPedido > 0) {
																				echo number_format($descuentoGeneralPedido, 2) . ' %';
																			} else {
																				echo '0 %';
																			}
																			?>
																		...
																		<td class="text-end">
																			$
																			<?php
																			$totalConDescuento = $montoTotalDelPedidoSinDescuentoGral -
																				($montoTotalDelPedidoSinDescuentoGral * $descuentoGeneralPedido) / 100;
																			echo number_format(
																				$totalConDescuento,
																				2
																			);
																	...
																	<tr>
																		...
																		<td class="text-end">
																			<?php
																			if (getOneValueOfJsonData($dataArrayPedidoSeleccionado, 'costo_envio') != '') {
																				echo '$ ' . getOneValueOfJsonData($dataArrayPedidoSeleccionado, 'costo_envio');
																			} else {
																				echo '$ 00.00';
																			}
																			?>
																	...
																	<!--begin::Grand total-->
																	<tr>
																		<td colspan="5" class="fs-3 text-dark text-end">TOTAL</td>
																		<td class="text-dark fs-3 fw-bolder text-end">
																			$
																			<?php
																			echo number_format(getOneValueOfJsonData($dataArrayPedidoSeleccionado, 'debe'), 2);
																			?>
																		</td>
																	</tr>
																	<!--end::Grand total-->
