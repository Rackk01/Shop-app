    ...
    return {
        init: function () {
            ...
            ["#kt_ecommerce_add_product_description", "#kt_ecommerce_add_product_meta_description"].forEach((e => {
                ...
                // url: 'http://localhost/Santiago/santiago-app/php/libs/mod-img-upload/compresion.php',
                url: URL_APP + 'php/libs/mod-img-upload/compresion.php', // "https://.com/scripts/void.php",
                paramName: "file",
                maxFiles: 10,
                maxFilesize: 1000,
                addRemoveLinks: !0,
            ...
            //                 console.log("validated!"), "Valid" == e ? (o.setAttribute("data-kt-indicator", "on"), setTimeout((function () {
            //                     o.removeAttribute("data-kt-indicator"), Swal.fire({
            //                         text: "Los datos fueron guardados/actualizados correctamente!",
            //                         icon: "success",
            //                         buttonsStyling: !1,
            //                         showCancelButton: !0,
            ...
            //                         }
            //                     }).then((function (e) {
            //                         e.isConfirmed && (o.disabled = !1, window.location = 'product-list') // t.getAttribute("data-kt-redirect"))
            //                     }))
            //                 }), 2e3)) : Swal.fire({
            //                     html: "Disculpe, detectamos algunos errores en la solicitud, pruebe nuevamente. <br/><br/>Tenga en cuenta que puede haber errores en la sección <strong>General</strong> o <strong>Avanzado</strong>",
            //                     icon: "error",
            //                     buttonsStyling: !1,
