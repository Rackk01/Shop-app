						...
						<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
							...
							<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
								...
								<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
									<!--begin::Title-->
									<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Listado de pedidos</h1>
									<!--end::Title-->
									<!--begin::Breadcrumb-->
									...
									<div class="card-header align-items-center py-5 gap-2 gap-md-5">
										...
										<div class="card-title">
											...
											<div class="d-flex align-items-center position-relative my-1">
												...
												<!--end::Svg Icon-->
												<input type="text" data-kt-ecommerce-order-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Buscar Pedido" />
											</div>
											<!--end::Search-->
										</div>
										<!--end::Card title-->
										...
										<div class="card-toolbar flex-row-fluid justify-content-end gap-5">
											<div class="input-group w-250px">
												<input class="form-control form-control-solid rounded rounded-end-0" placeholder="Selec. rango fechas" id="kt_ecommerce_sales_flatpickr" />
										...
										<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_sales_table">
											...
											<thead>
												...
												<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
													...
													<th class="text-end min-w-100px">Fecha Pedido</th>
													<th class="text-end min-w-100px">Fecha entrega</th>
											...
											<tbody class="fw-semibold text-gray-600">
												<?php
												$dataArrayAllPedidos = getAllSales();
												$amount = count(json_decode($dataArrayAllPedidos, true));
												// echo $dataArrayAllPedidos;
												if ($amount > 0) {
													$contador = 0;
													foreach (json_decode($dataArrayAllPedidos, true) as $dato) {
														// if($contador >= 10){
														// 	break;
														// }
														// $contador++;
												...
												?>
														<tr>
															...
															<td data-kt-ecommerce-order-filter="order_id">
																<a href="sale-edit?cod=<?php echo $dato['nrocomp']; ?>" class="text-gray-800 text-hover-primary fw-bold">
																	<?php echo $dato['nrocomp']; ?>
																</a>
															</td>
															<!--end::Order ID=-->
															<!--begin::Customer=-->
															...
															<td class="text-end pe-0" data-order="Completed">
																<!--begin::Badges-->
																<!-- Registrado, Preparado, Enviado, Entregado, Vencido, Cancelado -->
																<div class="badge badge-light-<?php echo strtolower(trim($dato['estado'])); ?>">
															...
															<td class="text-end pe-0">
																<span class="fw-bold">
																	$
																	<?php echo number_format($dato['debe'], 2); ?>
																</span>
															</td>
															<!--end::Total=-->
															<!--begin::Date Added=-->
															<td class="text-end" data-order="<?php echo (trim($dato['fecha'])); ?>">
																<span class="fw-bold"><?php echo changeDateFormat1(trim($dato['fecha'])); ?></span>
															</td>
															<!--end::Date Added=-->
															<!-- begin::Date Modified= FECHA DE ENTREGA -->
															<?php
															$fechaEntrega = '-';
															if ($dato['fecha_entrega'] != null && trim($dato['fecha_entrega']) != '') {
																$fechaEntrega = changeDateFormat1(trim($dato['fecha_entrega']));
															}
															?>
															<td class="text-end" data-order="<?php echo $fechaEntrega; ?>">
																<span class="fw-bold"><?php echo $fechaEntrega; ?></span>
															</td>
															<!--end::Date Modified=-->
															<!--begin::Action=-->
															<td class="text-end">
																<a href="#" class="btn btn-sm btn-light btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Acción
																...
																<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
																	...
																	<div class="menu-item px-3">
																		<a href="sale-detail?cod=<?php echo trim($dato['nrocomp']); ?>" class="menu-link px-3">Ver</a>
																	</div>
																	<!--end::Menu item-->
																	<!--begin::Menu item-->
																	<div class="menu-item px-3">
																		<a href="sale-edit?cod=<?php echo $dato['nrocomp']; ?>" class="menu-link px-3">Editar</a>
																	</div>
																	<!--end::Menu item-->
																	<!--begin::Menu item-->
																	<!-- <div class="menu-item px-3">
