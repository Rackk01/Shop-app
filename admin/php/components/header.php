...
<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
	<a href="index" class="d-lg-none">
		<img alt="Logo" src="../src/img/empresa/logo-empres-tab.png" class="h-30px" />
	</a>
</div>
...
<div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
											...
											<div class="row">
												...
												<div class="col-lg-6">
													...
													<div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-2 mb-5 mb-lg-0 mx-lg-5">
														...
														<a href="1/layout-builder.html" class="btn btn-sm btn-primary fw-bold">Try Builder</a>
													</div>
	...
	<div class="app-navbar flex-shrink-0">
		...
		<!-- DATOS DE USUARIO LOGUEADO / USER PROFILE -->
		<div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
			...
			<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
				<div class="menu-item px-3">
					<div class="menu-content d-flex align-items-center px-3">
						...
						<div class="d-flex flex-column">
							<div class="fw-bold d-flex align-items-center fs-5">Cuenta
				...
				<div class="menu-item px-5">
					<a onclick="return false;" class="menu-link px-5">Mi perfil</a>
				</div>
				...
				<div class="menu-item px-5">
					<a onclick="closeSessionAdmin(); return false;" class="menu-link px-5">Cerrar sesión</a>
				</div>
...
<!-- <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
	<a href="dashboard" class="d-lg-none">
		<img alt="Logo" src="../../../src/img/empresa/LogoEmpresaRectangular.jpg" class="h-30px" />
	</a>
</div> -->
<!--end::Mobile logo-->