...
final class DocParser
{
    ...
    /**
     * Flag to control if the current annotation is ed or not.
     *
     * @var bool
     */
    private $isedAnnotation = false;
...
EXCEPTION
        ...
        //if target is ed annotation
        $target = $this->isedAnnotation ? Target::TARGET_ANNOTATION : $this->target;

        // Next will be ed
        $this->isedAnnotation = true;
