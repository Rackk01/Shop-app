...
<body>
            ...
            <div class="container">
                <div class="row">
                    <section class="text-center mb-50">
                        <h2 class="title style-3 mb-40">¿Necesitas recuperar tu contraseña?</h2>
                        <div class="row d-flex justify-content-center">
                            ...
                            <div class="col-lg-4 col-md-6 mb-24">
                                <div class="featured-card">
                                    ...
                                    <p>Ingresa el <strong>email</strong> correspondiente a la cuenta que deseas recuperar y te enviaremos un correo para que sigas los pasos.</p>
                                    <!-- <a href="#">Read more</a> -->
                                    <div class="padding_eight_all bg-white">
                                        ...
                                        <form id="id-form-recover" method="post">
                                            <div class="form-group">
                                                <input type="email" required="" id="id-input-email" name="email" placeholder="Email *" />
                                            </div>

                                            <div class="form-group">
                                                <button type="submit" class="btn btn-heading btn-block hover-up" name="recuperar" style="width: 100%;">
                                                    Recuperar
                                                </button>
                            ...
                            <div class="col-lg-6 col-md-8">
                                <div class="login_wrap widget-taber-content background-white">
                                    <div class="padding_eight_all bg-white">
                                        <div class="heading_s1">
                                            <h1 class="mb-5">Recuperar contraseña</h1>
                                            <p class="mb-30">Todavía no tenés una cuenta? <a href="create-account">Creala aquí</a></p>
                                        </div>
                                        <form id="id-form-login" method="post">
                                            ...
                                            <div class="form-group">
                                                <input required="" id="id-input-password" type="password" name="password" placeholder="Password *" />
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <button type="submit" class="btn btn-heading btn-block hover-up" name="login" style="width: 100%;">
                                                    Recuperar
                                                </button>
    ...
    <script src="js/view/recover-password.js"></script>
</body>
